...
const config: Config = {
  ...
  content: ["./src/**/*.{ts,tsx}"],
  safelist: [
    "bg-primary", "text-on-primary", "border-primary", "text-primary",
    "bg-gold", "text-gold", "border-gold",
    "text-emerald", "text-terra", "text-up", "text-down",
  ],
  theme: {
    container: {
      center: true,
    ...
    extend: {
      ...
      fontSize: {
        // Binance hierarchy
        "hero-display": ["clamp(2.5rem, 6vw, 4rem)",      { lineHeight: "1.1",  letterSpacing: "-0.02em", fontWeight: "700" }],
        ...
        "display-md":   ["clamp(1.625rem, 2.8vw, 2.25rem)", { lineHeight: "1.15", letterSpacing: "-0.01em", fontWeight: "600" }],
        "display-sm":   ["clamp(1.375rem, 2vw, 1.75rem)",   { lineHeight: "1.2",  letterSpacing: "-0.005em", fontWeight: "600" }],
