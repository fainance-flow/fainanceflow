...
export const refresh = (refreshToken: string): Promise<AxiosResponse<{ accessToken: string; refreshToken: string }>> =>
  axios.post("/auth/refresh", { refreshToken });

export const logout = (): Promise<AxiosResponse<{ ok: true }>> =>
